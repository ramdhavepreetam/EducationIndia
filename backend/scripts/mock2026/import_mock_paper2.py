...
SRC=os.path.join(_HERE,'msce_class5_paper2_mock_2026.json')
...
IMG_PREFIX=f'{BASE_URL}/static/mock2026p2/'
...
async def main():
    ...
    async with c.transaction():
        ...
        ev=await c.fetchval("""insert into exam_events(board_id,category_id,title_en,title_mr,std_class,year,is_active)
             ...
             board,cat,'SCRATCH — Mock Test 2026 Paper II (vendor import)','स्क्रॅच — सराव चाचणी २०२६ पेपर २',
        ...
        exam=await c.fetchval("""insert into exams(event_id,paper_code,set_code,paper_number,title_en,title_mr,medium,
             ...
             ev,paper['paper_code'],'M26B','Mock Test 2026 — Paper II','सराव चाचणी २०२६ — पेपर २')
