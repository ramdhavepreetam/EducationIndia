...
with open('answers_2017.json') as f:
    answers = json.load(f)

with open('marathi_2017.json') as f:
...
if __name__ == "__main__":
    try:
        # Get Event ID for 2017
        cur.execute("SELECT id FROM exam_events WHERE year=2017 LIMIT 1")
        ...
        p1 = extract_pdf_questions('/Users/preetam/Desktop/Exam_Papers/Question_Papers/Feb_2017/5th/English_Paper1.pdf', 1, 75, 1)
        
        print("Extracting Paper 2 (Intelligence)...")
        p2_intel = extract_pdf_questions('/Users/preetam/Desktop/Exam_Papers/Question_Papers/Feb_2017/5th/English_Paper2.pdf', 26, 75, 5)
        ...
        conn.commit()
        print("Successfully imported all 150 questions for 2017!")
