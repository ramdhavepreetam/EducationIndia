...
with open('answers_2022.json') as f:
    answers = json.load(f)

with open('marathi_2022.json') as f:
...
if __name__ == "__main__":
    try:
        # Get Event ID for 2022
        cur.execute("SELECT id FROM exam_events WHERE year=2022 LIMIT 1")
        ...
        p1 = extract_pdf_questions('/Users/preetam/Desktop/Exam_Papers/Question_Papers/Feb_2022/5th/English_Paper1.pdf', 1, 75, 1)
        
        print("Extracting Paper 2 (Intelligence)...")
        p2_intel = extract_pdf_questions('/Users/preetam/Desktop/Exam_Papers/Question_Papers/Feb_2022/5th/English_Paper2.pdf', 26, 75, 5)
        ...
        conn.commit()
        print("Successfully imported all 150 questions for 2022!")
