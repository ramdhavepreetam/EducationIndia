...
with open('answers_2018.json') as f:
    answers = json.load(f)

with open('marathi_2018.json') as f:
...
if __name__ == "__main__":
    try:
        # Get Event ID for 2018
        cur.execute("SELECT id FROM exam_events WHERE year=2018 LIMIT 1")
        ...
        p1 = extract_pdf_questions('/Users/preetam/Desktop/Exam_Papers/Question_Papers/Feb_2018/5th/English_Paper1.pdf', 1, 75, 1)
        
        print("Extracting Paper 2 (Intelligence)...")
        p2_intel = extract_pdf_questions('/Users/preetam/Desktop/Exam_Papers/Question_Papers/Feb_2018/5th/English_Paper2.pdf', 26, 75, 5)
        ...
        for i in range(1, 76):
            ...
            if i <= 25:
                if (i-1) < len(marathi_qs):
                    ...
                    insert_question(p2_id, p2_sec1, t_p2_s1, i, "[IMAGE BASED QUESTION - PENDING CROP]", None, ["", "", "", ""], correct)
            else:
                if i in p2_intel:
        ...
        conn.commit()
        print("Successfully imported all 150 questions for 2018!")
